...
public class L07Q01 {
    ...
    public static void writeDatFile(){
        try(ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("src/Week07/Lab07/course.dat"))){
    ...
    public static void readDatFile(String courseCode){
        try(ObjectInputStream in = new ObjectInputStream(new FileInputStream("src/Week07/Lab07/course.dat"))){
            boolean flag = false;
            while(true){
                try {
